...
def registrar_rutas(app):
    ...
    def gestionar_tipo_ministro():
        ...
        return render_template("ministro/gestionar_tipo_ministro.html", tipos_ministro=tipos_ministro)
    ...
    def formulario_registrar_tipo_ministro():
        return render_template("ministro/registrar_tipo_ministro.html")
    ...
    def formulario_editar_tipo_ministro(id):
        ...
        return render_template("ministro/editar_tipo_ministro.html", tipo_ministro=tipo_ministro)
